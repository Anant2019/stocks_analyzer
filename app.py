...
<div style="background-color:#fff3cd; padding:15px; border-radius:10px; border:1px solid #ffeeba;">
    ...
    <p style="color:#856404; font-size:0.9em;">
        We are not SEBI registered research analysts or investment advisors. The signals generated by this algorithm are based on historical data and mathematical formulas. 
        Trading in the stock market involves high risk. Please consult a certified financial advisor before making any investment decisions. 
